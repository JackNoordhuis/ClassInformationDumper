...
/**
 * list-namespaces.php – ClassInformationDumper
 *
...
switch ($FORMAT) {
    case 'json':
        $lines[] = json_encode($namespaceList);
        break;
    case 'php':
        $lines[] = '<?php'.PHP_EOL.PHP_EOL;
        $lines[] = Helper::stripBlankLines(Helper::stripNumericKeys(var_export($namespaceList, true))).';';
        break;
    case 'serialize':
        $lines[] = serialize($namespaceList);
        break;
}
