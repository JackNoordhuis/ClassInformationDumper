...
/**
 * list-methods.php – ClassInformationDumper
 *
...
switch ($FORMAT) {
    case 'json':
        $lines[] = json_encode($methodList);
        break;
    case 'php':
        $lines[] = '<?php'.PHP_EOL.PHP_EOL;
        $lines[] = Helper::stripBlankLines(Helper::stripNumericKeys(var_export($methodList, true))).';';
        break;
    case 'serialize':
        $lines[] = serialize($methodList);
        break;
}
